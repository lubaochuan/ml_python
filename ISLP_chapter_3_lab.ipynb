  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/lubaochuan/ml_python/blob/main/ISLP_chapter_3_lab.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
      ...
      "source": [
        ...
        "- Bias–variance intuition with interactive sliders\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "- R² = 1 means perfect explanation\n",
        "- High R² does NOT guarantee good predictions on new data\n"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        "## Step 6: Bias–Variance Intuition with Model Complexity"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        "## Step 7: Failure Case – Nonlinear Relationship"
      ]
    },
    {
      "cell_type": "code",
    ...
    },
    {
      ...
      "source": [
        "\n",
        "1. What does R² measure, and what does it not measure?\n",
